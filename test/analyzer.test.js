...
const semanticErrors = [
  ...
  ["undeclared variable with multiple scopes", "mine x = 3 playtime f(x: numba) { bedtime y }", /Undefined variable/],
  ["wrong number of arguments in function call", "playtime f() { bedtime 1 } gibberish(f(1))", /Expected 0 arguments/],
  [
